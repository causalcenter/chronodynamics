# chron_dynamics Codebase Guide for Agents
...
The project is a monorepo containing the followng library crates:
* `data_manager`: Manages acess to experimental data
* `deep_causality_physics`: Standard library of physics formulas and engineering primitives.
* `experiments`: A collection of physics related experiments.
